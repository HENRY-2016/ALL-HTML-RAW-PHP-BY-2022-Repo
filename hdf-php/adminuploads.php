...
function AdminViewItemNamesEndPoint ()
{
    ...
    elseif ($itemtype == "BOXES_LAST_SUPPER_UPLOAD"){AdminViewItemNames_BoxesAfricanAnimals ();}
    ...
    elseif ($itemtype == "TABLES_LAST_SUPPER_UPLOAD"){AdminViewItemNames_TablesAfricanAnimals ();}
    ...
    elseif ($itemtype == "WALL_HANGINGS_LAST_SUPPER_UPLOAD"){AdminViewItemNames_WallHangingsAfricanAnimals ();}
    ...
    elseif ($itemtype == "CHAIRS_LAST_SUPPER_UPLOAD"){AdminViewItemNames_ChairsAfricanAnimals ();}
    
    elseif ($itemtype == "DOORS_UPLOAD"){AdminViewItemNames_Doors ();}
    elseif ($itemtype == "STATUES_PEOPLE_UPLOAD"){AdminViewItemNames_Statues ();}
    elseif ($itemtype == "LAMP_HOLDERS_UPLOAD"){AdminViewItemNames_LampHolders ();}
    elseif ($itemtype == "WALKING_STICKS_UPLOAD"){AdminViewItemNames_WalkingSticks ();}
    elseif ($itemtype == "CUPS_UPLOAD"){AdminViewItemNames_Cups ();}
    elseif ($itemtype == "ASH_TREYS_UPLOAD"){AdminViewItemNames_AshTreys ();}
...
function AdminViewItemNameToUpdateEndPoint ()
{
    ...
    elseif ($itemtype == "BOXES_LAST_SUPPER_UPLOAD"){AdminViewItemNameToUpdate_BoxesAfricanAnimals ($id);}
    ...
    elseif ($itemtype == "TABLES_LAST_SUPPER_UPLOAD"){AdminViewItemNameToUpdate_TablesAfricanAnimals ($id);}
    ...
    elseif ($itemtype == "WALL_HANGINGS_LAST_SUPPER_UPLOAD"){AdminViewItemNameToUpdate_WallHangingsAfricanAnimals ($id);}
    ...
    elseif ($itemtype == "CHAIRS_LAST_SUPPER_UPLOAD"){AdminViewItemNameToUpdate_ChairsAfricanAnimals ($id);}

    elseif ($itemtype == "DOORS_UPLOAD"){AdminViewItemNameToUpdate_Doors ($id);}
    elseif ($itemtype == "STATUES_PEOPLE_UPLOAD"){AdminViewItemNameToUpdate_Statues ($id);}
    elseif ($itemtype == "LAMP_HOLDERS_UPLOAD"){AdminViewItemNameToUpdate_LampHolders ($id);}
    elseif ($itemtype == "WALKING_STICKS_UPLOAD"){AdminViewItemNameToUpdate_WalkingSticks ($id);}
    elseif ($itemtype == "CUPS_UPLOAD"){AdminViewItemNameToUpdate_Cups ($id);}
    elseif ($itemtype == "ASH_TREYS_UPLOAD"){AdminViewItemNameToUpdate_AshTreys ($id);} 
}
        ...
        else
        {
            ...
            { 
                ...
                else
                {
                    ...
                    if ($itemtype == "BOXES_UPLOAD"){InsertInto_Boxes($id,$img_name ,$description);}
                    elseif ($itemtype == "LOGOS_UPLOAD"){InsertInto_Logos($id,$img_name ,$description);}


                    elseif ($itemtype == "MAPS_UPLOAD"){InsertInto_Maps($id,$img_name,$description);}
                    elseif ($itemtype == "LAST_SUPPER_UPLOAD"){InsertInto_Last_Supper($id,$img_name,$description);}
                    elseif ($itemtype == "STATUES_PEOPLE_UPLOAD"){InsertInto_Statues_People($id,$img_name,$description);}
                    elseif ($itemtype == "STATUES_ANIMALS_UPLOAD"){InsertInto_Statues_Animals($id,$img_name,$description);}
                    elseif ($itemtype == "TABLES_ROUND_UPLOAD"){InsertInto_Tables_Round($id,$img_name,$description);}
                    elseif ($itemtype == "TABLES_SQUARE_UPLOAD"){InsertInto_Tables_Square($id,$img_name,$description);}
                    elseif ($itemtype == "TABLES_DAINNING_UPLOAD"){InsertInto_Tables_Dainning($id,$img_name,$description);}
                    elseif ($itemtype == "DOORS_PLAIN_UPLOAD"){InsertInto_Doors_Plain($id,$img_name,$description);}
                    elseif ($itemtype == "DOORS_DESIGN_UPLOAD"){InsertInto_Doors_Design($id,$img_name,$description);}
                    elseif ($itemtype == "DOORS_TROFHIES_UPLOAD"){InsertInto_Trofhies($id,$img_name,$description);}


                    elseif ($itemtype == "WALL_HANGINGS_UPLOAD"){InsertInto_WallHangings($id,$img_name,$description);}
                    elseif ($itemtype == "CHAIRS_UPLOAD"){InsertInto_Chairs($id,$img_name,$description);}

                    elseif ($itemtype == "LAMP_HOLDERS_UPLOAD"){InsertInto_LampHolders($id,$img_name,$description);}
                    
                    elseif ($itemtype == "WALKING_STICKS_UPLOAD"){InsertInto_WalkingSticks($id,$img_name,$description);}
                    elseif ($itemtype == "CUPS_UPLOAD"){InsertInto_Cups($id,$img_name,$description);}
                    elseif ($itemtype == "ASH_TREYS_UPLOAD"){InsertInto_AshTreys($id,$img_name,$description);}
...
function AdminUpdateItemEndPoint ()
{
    ...
    else
    {
        ...
        else
        {
            ...
            elseif ($itemtype == "BOXES_LAST_SUPPER_UPLOAD"){AdminUpdateItem_BoxesAfricanAnimals ($oldname,$newname);}
            ...
            elseif ($itemtype == "TABLES_LAST_SUPPER_UPLOAD"){AdminUpdateItem_TablesAfricanAnimals ($oldname,$newname);}
            ...
            elseif ($itemtype == "WALL_HANGINGS_LAST_SUPPER_UPLOAD"){AdminUpdateItem_WallHangingsAfricanAnimals ($oldname,$newname);}
            ...
            elseif ($itemtype == "CHAIRS_LAST_SUPPER_UPLOAD"){AdminUpdateItem_ChairsAfricanAnimals ($oldname,$newname);}

            elseif ($itemtype == "DOORS_UPLOAD"){AdminUpdateItem_Doors ($oldname,$newname);}
            elseif ($itemtype == "STATUES_PEOPLE_UPLOAD"){AdminUpdateItem_Statues ($oldname,$newname);}
            elseif ($itemtype == "LAMP_HOLDERS_UPLOAD"){AdminUpdateItem_LampHolders ($oldname,$newname);}
            elseif ($itemtype == "WALKING_STICKS_UPLOAD"){AdminUpdateItem_WalkingSticks ($oldname,$newname);}
            elseif ($itemtype == "CUPS_UPLOAD"){AdminUpdateItem_Cups ($oldname,$newname);}
            elseif ($itemtype == "ASH_TREYS_UPLOAD"){AdminUpdateItem_AshTreys ($oldname,$newname);}
...
function AdminDeleteItemEndPoint ()
{
    ...
    else
    {
        ...
        else
        {
            ...
            elseif ($itemtype == "BOXES_LAST_SUPPER_UPLOAD"){AdminDeleteItem_BoxesAfricanAnimals ($oldname);}
            ...
            elseif ($itemtype == "TABLES_LAST_SUPPER_UPLOAD"){AdminDeleteItem_TablesAfricanAnimals ($oldname);}
            ...
            elseif ($itemtype == "WALL_HANGINGS_LAST_SUPPER_UPLOAD"){AdminDeleteItem_WallHangingsAfricanAnimals ($oldname);}
            ...
            elseif ($itemtype == "CHAIRS_LAST_SUPPER_UPLOAD"){AdminDeleteItem_ChairsAfricanAnimals ($oldname);}

            elseif ($itemtype == "DOORS_UPLOAD"){AdminDeleteItem_Doors ($oldname);}
            elseif ($itemtype == "STATUES_PEOPLE_UPLOAD"){AdminDeleteItem_Statues ($oldname);}
            elseif ($itemtype == "LAMP_HOLDERS_UPLOAD"){AdminDeleteItem_LampHolders ($oldname);}
            elseif ($itemtype == "WALKING_STICKS_UPLOAD"){AdminDeleteItem_WalkingSticks ($oldname);}
            elseif ($itemtype == "CUPS_UPLOAD"){AdminDeleteItem_Cups ($oldname);}
            elseif ($itemtype == "ASH_TREYS_UPLOAD"){AdminDeleteItem_AshTreys ($oldname);}
